...
parser.add_argument('--numImages', type=int, default=2000,
...
parser.add_argument('--imageDims', type=tuple,
                    default=(128, 128), help='dimensions of image')

parser.add_argument('--noiseSize', type=int, default=100,
                    help='length of noise vector into generator')
parser.add_argument('--numChannels', type=int, default=3,
                    help='number of input channels to discriminator (typically RGB)')
parser.add_argument('--featureMultiplier', type=int, default=64,
                    help='size of feature maps in gen and disc')
...
parser.add_argument('--outputNum', type=int,
                    default=10, help='images to output')
